...
async function main() {
    ...
    const salon1 = await prisma.salon.create({
        data: {
            ...
            description: 'Premium beauty salon in the heart of Hanoi. We offer haircuts, coloring, and styling services.',
    ...
    const salon2 = await prisma.salon.create({
        data: {
            ...
            description: 'Professional nail art and manicure services in Ho Chi Minh City.',
